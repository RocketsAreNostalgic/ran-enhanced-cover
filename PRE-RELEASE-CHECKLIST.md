...
Use this as the final outstanding-work list before publishing RAN Video Cover to
...
- [ ] Confirm the WordPress.org plugin slug `ran-video-cover`, contributor
...
- [ ] Confirm all user-facing PHP and JavaScript strings are wrapped in the
      appropriate WordPress i18n function with the `ran-video-cover` text
...
- [ ] Regenerate `languages/ran-video-cover.pot` with `pnpm pot` after all
